...
using TMPro;
using System.IO;
using Game003v2_GravitySwitch;

public static class Setup003v2_GravitySwitch
{
    [MenuItem("Assets/Setup/003v2 GravitySwitch")]
    public static void CreateScene()
    {
        if (EditorApplication.isPlaying) { Debug.LogError("[Setup003v2] Play モード中は実行できません。"); return; }
        ...
        string scenePath = "Assets/Scenes/003v2_GravitySwitch.unity";
        EditorSceneManager.SaveScene(scene, scenePath);
        AddSceneToBuildSettings(scenePath);
        Debug.Log("[Setup003v2] GravitySwitch シーンを作成しました: " + scenePath);
    }
