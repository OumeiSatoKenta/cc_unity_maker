...
public static class Setup001_BlockFlow
{
    ...
    {
        if (EditorApplication.isPlaying) { Debug.LogError("[Setup001] Play モード中は実行できません。"); return; }
        var scene = EditorSceneManager.NewScene(NewSceneSetup.DefaultGameObjects, NewSceneMode.Single);
        var jpFont = AssetDatabase.LoadAssetAtPath<TMP_FontAsset>("Assets/Fonts/NotoSansJP-Regular SDF.asset");
        string sp = "Assets/Resources/Sprites/Game001_BlockFlow/";
        ...
        Debug.Log("[Setup001] BlockFlow シーンを作成しました: " + scenePath);
    }
