...
public static class Setup053_SlideBlitz
{
    ...
    public static void CreateScene()
    {
        ...
        string sp = "Assets/Resources/Sprites/Game053_SlideBlitz/";
        ...
        var pmObj = new GameObject("PuzzleManager"); pmObj.transform.SetParent(gmObj.transform);
        ...
        pmSO.FindProperty("_tileSprite").objectReferenceValue = tileSprite;
        pmSO.FindProperty("_gridSize").intValue = 4;
        ...
        var timerText = CT(canvasObj.transform, "TimerText", "60.0s", 36, jpFont, new Vector2(1,1), new Vector2(1,1), new Vector2(1,1), new Vector2(200,50), new Vector2(-20,-20));
        ...
        var movesText = CT(canvasObj.transform, "MovesText", "0手", 36, jpFont, new Vector2(0,1), new Vector2(0,1), new Vector2(0,1), new Vector2(200,50), new Vector2(20,-20));
        movesText.GetComponent<TextMeshProUGUI>().alignment = TextAlignmentOptions.Left;
        ...
        CT(clearPanel.transform, "CT", "パズル完成！", 52, jpFont, new Vector2(0.5f,0.75f), new Vector2(0.5f,0.75f), new Vector2(0.5f,0.5f), new Vector2(600,100), Vector2.zero).GetComponent<TextMeshProUGUI>().alignment = TextAlignmentOptions.Center;
        ...
        var uiObj = new GameObject("SlideBlitzUI"); uiObj.transform.SetParent(gmObj.transform);
        ...
        gmSO.FindProperty("_puzzleManager").objectReferenceValue = pm;
        gmSO.FindProperty("_ui").objectReferenceValue = ui;
        gmSO.FindProperty("_timeLimit").floatValue = 60f;
        ...
        string scenePath = "Assets/Scenes/053_SlideBlitz.unity";
        EditorSceneManager.SaveScene(scene, scenePath);
        AddSceneToBuildSettings(scenePath);
        Debug.Log("[Setup053] SlideBlitz シーンを作成しました: " + scenePath);
    }
