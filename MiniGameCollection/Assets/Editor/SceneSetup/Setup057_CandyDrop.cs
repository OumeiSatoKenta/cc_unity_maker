...
public static class Setup057_CandyDrop
{
    ...
    public static void CreateScene()
    {
        ...
        string sp = "Assets/Resources/Sprites/Game057_CandyDrop/";
        ...
        Sprite candyRoundSprite = LoadSprite(sp + "candy_round.png");
        Sprite candySquareSprite = LoadSprite(sp + "candy_square.png");
        ...
        var platformObj = new GameObject("Platform"); var platSr = platformObj.AddComponent<SpriteRenderer>();
        platSr.sprite = platformSprite; platSr.sortingOrder = 0;
        platformObj.transform.position = new Vector3(0f, -4f, 0f);
        platformObj.AddComponent<BoxCollider2D>();
        var platRb = platformObj.AddComponent<Rigidbody2D>(); platRb.bodyType = RigidbodyType2D.Static;

        var gmObj = new GameObject("GameManager");
        var gm = gmObj.AddComponent<CandyDropGameManager>();

        var dmObj = new GameObject("DropManager"); dmObj.transform.SetParent(gmObj.transform);
        ...
        dmSO.FindProperty("_candyRoundSprite").objectReferenceValue = candyRoundSprite;
        dmSO.FindProperty("_candySquareSprite").objectReferenceValue = candySquareSprite;
        ...
        var heightText = CT(canvasObj.transform, "HeightText", "高さ: 0.0m", 36, jpFont, new Vector2(0.5f,1), new Vector2(0.5f,1), new Vector2(0.5f,1), new Vector2(300,50), new Vector2(0,-20));
        ...
        var goScoreText = CT(goPanel.transform, "GS", "", 36, jpFont, new Vector2(0.5f,0.55f), new Vector2(0.5f,0.55f), new Vector2(0.5f,0.5f), new Vector2(500,60), Vector2.zero);
        ...
        var uiObj = new GameObject("CandyDropUI"); uiObj.transform.SetParent(gmObj.transform);
        ...
        gmSO.FindProperty("_targetHeight").floatValue = 5f;
        ...
        string scenePath = "Assets/Scenes/057_CandyDrop.unity";
        EditorSceneManager.SaveScene(scene, scenePath);
        AddSceneToBuildSettings(scenePath);
        Debug.Log("[Setup057] CandyDrop シーンを作成しました: " + scenePath);
    }
