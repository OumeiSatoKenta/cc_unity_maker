...
public static class Setup050_BubbleSort
{
    ...
    public static void CreateScene()
    {
        ...
        string sp = "Assets/Resources/Sprites/Game050_BubbleSort/";

        var camera = Object.FindFirstObjectByType<Camera>();
        if (camera != null) { camera.backgroundColor = new Color(0.92f, 0.9f, 0.96f); camera.orthographic = true; camera.orthographicSize = 5.5f; }
        ...
        var smObj = new GameObject("SortManager"); smObj.transform.SetParent(gmObj.transform);
        var sm = smObj.AddComponent<SortManager>();
        var smSO = new SerializedObject(sm);
        smSO.FindProperty("_gameManager").objectReferenceValue = gm;
        smSO.FindProperty("_bubbleSprite").objectReferenceValue = bubbleSprite;
        ...
        var movesText = CT(canvasObj.transform, "MovesText", "残り: 20手", 36, jpFont,
        ...
        movesText.GetComponent<TextMeshProUGUI>().color = Color.black;

        var progressText = CT(canvasObj.transform, "ProgressText", "0/8", 36, jpFont,
        ...
        CT(clearPanel.transform, "CT", "ソート完了！", 52, jpFont,
        ...
        CT(goPanel.transform, "GT", "手数オーバー", 52, jpFont,
        ...
        var uiObj = new GameObject("BubbleSortUI"); uiObj.transform.SetParent(gmObj.transform);
        ...
        gmSO.FindProperty("_maxMoves").intValue = 20;
        gmSO.FindProperty("_bubbleCount").intValue = 8;
        ...
        string scenePath = "Assets/Scenes/050_BubbleSort.unity";
        EditorSceneManager.SaveScene(scene, scenePath);
        AddSceneToBuildSettings(scenePath);
        Debug.Log("[Setup050] BubbleSort シーンを作成しました: " + scenePath);
    }
