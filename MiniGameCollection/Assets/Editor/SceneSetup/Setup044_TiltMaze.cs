...
public static class Setup044_TiltMaze
{
    ...
    public static void CreateScene()
    {
        ...
        string sp = "Assets/Resources/Sprites/Game044_TiltMaze/";

        var camera = Object.FindFirstObjectByType<Camera>();
        if (camera != null) { camera.backgroundColor = new Color(0.2f, 0.16f, 0.12f); camera.orthographic = true; camera.orthographicSize = 5.5f; }
        ...
        mmSO.FindProperty("_ballSprite").objectReferenceValue = ballSprite;
        ...
        var timerText = CT(canvasObj.transform, "TimerText", "60.0s", 40, jpFont, new Vector2(0.5f,1), new Vector2(0.5f,1), new Vector2(0.5f,1), new Vector2(200,50), new Vector2(0,-20));
        ...
        var uiObj = new GameObject("TiltMazeUI"); uiObj.transform.SetParent(gmObj.transform);
        ...
        gmSO.FindProperty("_manager").objectReferenceValue = mm;
        ...
        string scenePath = "Assets/Scenes/044_TiltMaze.unity";
        EditorSceneManager.SaveScene(scene, scenePath); AddSceneToBuildSettings(scenePath);
        Debug.Log("[Setup044] TiltMaze シーンを作成しました: " + scenePath);
    }
