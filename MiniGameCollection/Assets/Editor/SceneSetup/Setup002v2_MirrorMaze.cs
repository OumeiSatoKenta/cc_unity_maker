...
using TMPro;
using System.IO;
using Game002v2_MirrorMaze;

public static class Setup002v2_MirrorMaze
{
    [MenuItem("Assets/Setup/002v2 MirrorMaze")]
    public static void CreateScene()
    {
        if (EditorApplication.isPlaying) { Debug.LogError("[Setup002v2] Play モード中は実行できません。"); return; }
        ...
        string scenePath = "Assets/Scenes/002v2_MirrorMaze.unity";
        EditorSceneManager.SaveScene(scene, scenePath);
        AddSceneToBuildSettings(scenePath);
        Debug.Log("[Setup002v2] MirrorMaze シーンを作成しました: " + scenePath);
    }
