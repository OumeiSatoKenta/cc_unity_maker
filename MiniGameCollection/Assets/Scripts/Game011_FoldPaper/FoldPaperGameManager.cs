...
namespace Game011_FoldPaper
{
    ...
    {
        [SerializeField] private FoldManager _foldManager;
        [SerializeField] private FoldPaperUI _ui;
        ...
        public void StartGame()
        {
            _moveCount = 0;
            _isCleared = false;
            if (_foldManager != null) _foldManager.SetupStage(_currentStage);
            if (_ui != null)
            {
        ...
        {
            _currentStage++;
            if (_currentStage >= FoldManager.StageCount) _currentStage = 0;
            StartGame();
        }
    }
}
